<x-lareon::admin-layout>
    ...
    <dev class="mb-3 bg-zinc-900 rounded p-3 text-slate-50 block w-full" style="box-shadow:-5px 0 0 0 green">
                <pre>
<code class="font-bold">&lt;<span>i</span> class='tkicon stroke-black fill-none' size='24' data-icon='example'&gt;&lt;<span>/i</span>&gt;</code>
</pre>
    </dev>
    <dev class="mb-3 bg-zinc-900 rounded p-3 text-slate-50 block w-full" style="box-shadow:-5px 0 0 0 blue">
        <pre>
