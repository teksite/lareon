<x-lareon::admin-editor-layout>
    ...
    @endsection
    @section('form')
        <x-lareon::sections.text :title="__('name')" name="name" :placeholder="__('enter a :title' ,['title'=>__('name')])" :required="true"  :value="old('name')"/>
        <x-lareon::sections.text type="email" :title="__('email')" name="email" :placeholder="__('enter a unique :title' ,['title'=>__('email')])" :required="true" :value="old('email')"/>
        <x-lareon::sections.text type="phone" :title="__('phone')" name="phone" :placeholder="__('enter a unique :title' ,['title'=>__('phone')])" :required="true" :value="old('phone')"/>
