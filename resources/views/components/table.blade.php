...
<div class="overflow-hidden">
    <table {!! $attributes->merge(['class' => 'min-w-full border border-zinc-200 overflow-x-scroll divide-y divide-zinc-200 rounded-lg tableData']) !!}>
        <thead class="rounded-xl border border-zinc-200">
        <tr>
            @php
        ...
        <tbody class="divide-y divide-zinc-200 *:hover:bg-blue-50">
        {!! $slot ?? ''!!}
        </tbody>
        @isset($foot)
            <tfoot>
